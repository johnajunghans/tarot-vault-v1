...
- 1.4.9 — Load Spread Template
- 1.4.11 — Search/Sort for Spreads List
- 1.4.12 — Undo/Redo for Card Canvas Placement
- 1.4.8 — Spread Versioning
...
- **1.4.8** — Spread versioning (`spread_versions`, lazy snapshots with readings, soft/cascade delete, `getByVersion`, tests). ~~Complete~~
- **1.4.9** — Load spread template (More Actions dropdown, draft + navigate to new spread, icon Close/Cancel). ~~Complete~~
...
- **1.4.11** — Search/sort for spreads list (client-side search, URL sort params, toolbar). ~~Complete~~
- **1.4.12** — Undo/redo for canvas placement (`use-canvas-history`, controls, zoom shortcuts). ~~Complete~~