...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      ...
      className={cn(
        "bg-secondary p-[3px] !rounded-lg data-[size=sm]:rounded-[min(var(--radius-md),10px)] data-[size=mobile-lg]:h-12 data-[size=mobile-lg]:px-1 group/toggle-group flex w-fit flex-row items-center gap-[--spacing(var(--gap))] data-vertical:flex-col data-vertical:items-stretch",
        className
      )}
      {...props}
    >
